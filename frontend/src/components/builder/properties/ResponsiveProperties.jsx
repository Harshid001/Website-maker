  ...
  return (
    <PropertyGroup title="Responsive Settings">
      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-950 p-3 mt-3">
        <p className="mb-2 text-[10px] font-bold uppercase tracking-widest text-slate-500">Per-device overrides</p>
      ...
      <MiniButton onClick={() => { showToast(`Switched to ${activeDevice === 'desktop' ? 'tablet' : activeDevice === 'tablet' ? 'mobile' : 'desktop'} preview.`); setActiveDevice(activeDevice === 'desktop' ? 'tablet' : activeDevice === 'tablet' ? 'mobile' : 'desktop'); }}>
